...
function ExploredCard({
  ...
  return (
    <div className="h-[16rem] lg:h-[18rem] w-full lg:w-[18rem] shadow-lg flex flex-col cursor-pointer gap-4 border border-zinc-300 dark:border-zinc-800 pt-4 pb-10 relative rounded-[12px] hover:shadow-[0_5px_15px_rgba(0,0,0,0.25)] dark:hover:shadow-[0_5px_15px_rgba(0,0,0,0.45)]">
