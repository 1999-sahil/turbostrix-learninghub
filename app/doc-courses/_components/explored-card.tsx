...
function ExploredCard({
  ...
  return (
    <div className="h-[16rem] lg:h-[18rem] w-full lg:w-[18rem] bg-white dark:bg-zinc-900 flex flex-col cursor-pointer gap-4 border border-zinc-300 dark:border-zinc-800 pt-4 pb-10 relative rounded-[12px] hover:shadow-[0_2px_2px_2px_rgba(0,0,0,0.10)] dark:hover:shadow-[0_2px_2px_2px_rgba(0,0,0,0.25)]">
      ...
      <div className="h-[8rem] w-full relative flex items-center justify-center">
        ...
        <Image
          ...
          width={60}
          height={60}
          className="z-10 max-md:w-[50px] max-md:h-[50px] rounded-full p-2 bg-zinc-100 dark:bg-zinc-800 border border-zinc-300/50 dark:border-zinc-700"
        />
      </div>
      <div className="flex flex-col gap-4 px-3">
        <div className="flex gap-2">
          <span className="flex items-center justify-center px-1 py-[2px] lg:px-2 lg:py-1 text-[8px] md:text-xs font-openSans font-medium bg-gray-200 dark:bg-gray-800 rounded-[4px]">
            {chapters} Chapters
          </span>
      ...
      <Link href={redirectLink} className="absolute bottom-0 right-0">
        <button className="border border-zinc-300 dark:border-black rounded-tl-[12px] rounded-br-[12px] px-6 py-1 text-xs md:text-sm font-kanit font-normal bg-zinc-300 dark:bg-black hover:bg-black hover:text-white dark:hover:bg-[#4534dd] dark:hover:border-[#4534dd]">
          View Doc
        </button>
      </Link>
    </div>
...
//box-shadow: drop-shadow-[0_5px_15px_rgba(0,0,0,0.35)];